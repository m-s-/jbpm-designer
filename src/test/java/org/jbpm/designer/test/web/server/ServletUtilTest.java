...
public class ServletUtilTest extends AbstractGuvnorIntegrationTest {
    ...
    @Test
    @InSequence(3)
    public void getPackageNamesFromGuvnorTest() { 
        runGetPackageNamesFromGuvnorTest(guvnorUrl, profile, servletContext);
    }
    
    public static void runGetPackageNamesFromGuvnorTest(URL guvnorUrl, IDiagramProfile profile, ServletContext servletContext) { 
